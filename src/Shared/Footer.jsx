...
const Footer = () => {
    return (
        <footer className="bg-[#242124] py-8 px-14">
            <div className="flex justify-between items-center border-b-2 border-gray-600 py-12">
                <h1 className="font-bold font-display text-6xl text-gray-200"><i>Discover your dream home</i></h1>
                <button className="text-white font-medium bg-[#ba8759] py-3 px-8">Search</button>
            </div>
            <div className="flex justify-between text-white py-12">
                ...
                <nav className="flex text-gray-300 gap-4">
