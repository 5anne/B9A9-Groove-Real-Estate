    ...
    return (
        <div>
            ...
            <div className="bg-blue-50 p-8 flex justify-center">
                <div className="bg-white m-14 p-10 w-1/2">
                    <h1 className="text-4xl font-medium text-center font-display pb-8">Contact Us</h1>
                    <div className="flex justify-center"><p className="border w-40 border-[#ba8759]"></p></div>
                    <div className="flex gap-8 mt-8">
                        <div className="bg-cyan-950 p-4 w-1/2">
