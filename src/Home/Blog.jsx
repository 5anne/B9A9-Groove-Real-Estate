            ...
            <div>
                <div className="hero min-h-screen" style={{ backgroundImage: 'url(https://i.postimg.cc/26nqskrP/Post-Image.jpg)' }}>
                    ...
                    <div className="hero-content text-center text-neutral-content">
                        <div className="w-1/2">
                            <h1 className="mb-5 text-3xl font-bold font-display">Décorate, Design, Maintain: Create Your Dream Home</h1>
                            <p className="mb-5">Unleash your inner home decorator and builder! This page provides all the inspiration and information you need to create your dream home. Dive into a world of stunning décor ideas, practical building design tips, and essential maintenance guides. Transform your living space into a masterpiece, one step at a time.</p>
                            <button className="bg-[#2f4f4f] text-white px-8 py-4 text-lg">Get Started</button>
                        </div>
                    </div>
                </div>
            </div>
            <div className="my-14 bg-[#ffefd5] py-12 px-8">
