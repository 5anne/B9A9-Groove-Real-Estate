...
const About = () => {
    return (
        <div>
            ...
            <Navbar></Navbar>
            <div className="my-14 bg-slate-500 py-10 px-4 flex flex-col lg:flex-row gap-8">
                <img className="lg:w-1/2" src={`https://i.postimg.cc/7LzsWWQf/real-estate.jpg`} alt="" />
                <div className="lg:w-1/2 h-full bg-zinc-900 p-6">
                    <p className="flex gap-2 items-center text-lime-500 font-semibold text-lg"><AiOutlineHome /> About Us</p>
                    <h1 className="font-bold text-xl lg:text-2xl text-slate-200">Welcome to <span className="font-display">Groove Real Estate Inc.</span>, where we guide you through every step of finding your perfect place.</h1>
                    <p className="my-2 text-slate-400 text-sm"><i>Whether you are a first-time buyer, seasoned investor, or looking to upsize or downsize, we understand the importance of finding a home that reflects your unique lifestyle. Our dedicated team of real estate professionals is passionate about helping you navigate the local market, discover hidden gems, and achieve your real estate goals.</i></p>
                    <h2 className="font-bold text-lg lg:text-xl text-slate-200">Our Missions:</h2>
